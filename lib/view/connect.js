...
function connect(mapStateToProps, MediatorClass, mapDispatchToProps, mergeProps) {
  var options = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : { withRef: true };
  ...
  return function wrapWithConnect(WrappedComponent) {
    ...
    var Connect = function (_Component) {
      ...
      _createClass(Connect, [{
        ...
        key: 'setViewState',
        value: function setViewState(state, cb) {
          var el = this.getWrappedInstance();
          if (el) {
